...
{
    public class NQM_CategoriesController : Controller
    {
        ...
        // GET: NQM_Categories/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: NQM_Categories/Create
